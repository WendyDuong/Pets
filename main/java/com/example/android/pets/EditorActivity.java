...
public class EditorActivity extends AppCompatActivity implements
    ...
    private boolean isEmptyNameString;
    ...
    private void savePet() {
        //reset boolean isEmptyNameString = false
        isEmptyNameString = false;
        ...
        //transfer from data imageView -> byte[]
        ...
        //prevent empty string of name
        if(TextUtils.isEmpty(nameString)){
            isEmptyNameString = true;
            Toast.makeText(this, "please enter a name for pet", Toast.LENGTH_LONG).show();
            return;
        }
        ...
        values.put(PetEntry.COLUMN_PET_IMAGE, image);
